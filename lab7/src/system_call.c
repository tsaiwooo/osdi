...
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_OPEN;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}
...
int close(int fd)
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_CLOSE;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}
...
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_WRITE;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}
...
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_READ;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}
...
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_MKDIR;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}
...
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_MOUNT;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}
...
{
    register unsigned long x8 asm("x8") __attribute__((unused)) = SYS_CHDIR;
    asm volatile("svc 0");
    register int val asm("x0");
    return val;
}